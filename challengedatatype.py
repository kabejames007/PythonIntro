...
for car in favorite_cars:
    if car["price"] > 100000:
        print(f"{car['make']} {car['model']} is priced at ${car['price']} which is over $100,000")
...
for car in favorite_cars:
    try:
        ...
        print(f"Error: Missing key {e} in car dictionary")
    except TypeError as e:
        print(f"Error: Price is not a number for {car['make']} {car['model']}")
